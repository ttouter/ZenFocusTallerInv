...
class ZenFocusApp(ctk.CTk):
    def __init__(self):
        ...
        self.bind("<Escape>", self.restaurar_desde_escape)
    ...
    def crear_menu_lateral(self):
        ...
        self.tabview.place(x=10, y=50, relheight=0.85)
    ...
    def validar_y_aplicar_personalizado(self):
        try:
            ...
            if min_enf > 0 and min_des > 0 and ciclos > 0:
                ...
                self.reset_timer()
                self.toggle_menu() 
                self.mostrar_alerta("✅ Tiempos aplicados", config.COLOR_PRIMARY)
            else:
    ...
    def toggle_menu(self):
        ...
        if self.menu_abierto:
            ...
            self.animar_menu(-self.ancho_menu)
